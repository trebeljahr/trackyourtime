// GENERATED by packages/raycast/scripts/vendor-core.mjs from packages/core/src/sync-client.ts.
// Do not edit. Change the source file, then run `pnpm vendor:raycast`.
import { API_LEVEL, parseClientVersion } from "../shared/api-level.js";
import { isSyncMessage, SESSION_REVOKED_CLOSE_CODE, type ServerToClientMessage, type SyncEvent } from "../shared/protocol.js";
