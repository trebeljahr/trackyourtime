// GENERATED by packages/raycast/scripts/vendor-core.mjs from packages/core/src/server-origin.ts.
...
import { API_LEVEL, CLIENT_TOO_OLD, parseApiLevel, SERVER_TOO_OLD, type VersionRefusal } from "../shared/api-level.js";
