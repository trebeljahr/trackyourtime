 ...
 * text and filenames. Amounts are `formatCents(toCents(x))` from totals.ts.
 *
 * Every function here is pure and locale-free. None of them produces an
 * exponent, a thousands separator or a float artefact (BR-DEC-*), and none
 * reads the clock.
 */
