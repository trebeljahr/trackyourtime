...
export const popup = {
  ...
  catalogEdit: {
    ...
    editClientTitle: "Edit client “{name}”",
    newTask: "New task…",
    ...
    editTagTitle: "Edit tag “{name}”",
    billableByDefault: "Billable by default",
    notBillableByDefault: "Not billable by default",
    hourlyRate: "Hourly rate",
    workspaceRate: "Workspace default",
    rateInvalid: "Enter a number of 0 or more, or leave it empty.",
    billingNewTimeOnly:
      "Applies to new time. To change time already tracked, edit the project in the web app.",
  },
  entryForm: {
