...
export const popup: Translation<typeof source> = {
  ...
  catalogEdit: {
    ...
    editProjectTitle: "Projekt „{name}“ bearbeiten",
    editClient: "Kunden {name} bearbeiten",
    editClientTitle: "Kunden „{name}“ bearbeiten",
    newTask: "Neue Tätigkeit …",
    newTaskTitle: "Neue Tätigkeit",
    editTask: "Tätigkeit {name} bearbeiten",
    editTaskTitle: "Tätigkeit „{name}“ bearbeiten",
    newTag: "Neues Schlagwort …",
    newTagTitle: "Neues Schlagwort",
    editTag: "Schlagwort {name} bearbeiten",
    editTagTitle: "Schlagwort „{name}“ bearbeiten",
    billableByDefault: "Standardmäßig abrechenbar",
    notBillableByDefault: "Standardmäßig nicht abrechenbar",
    hourlyRate: "Stundensatz",
    workspaceRate: "Standard des Arbeitsbereichs",
    rateInvalid: "Gib eine Zahl ab 0 ein oder lass das Feld leer.",
    billingNewTimeOnly:
      "Gilt für neue Zeit. Bereits erfasste Zeit änderst du am Projekt in der Web-App.",
  },
  entryForm: {
