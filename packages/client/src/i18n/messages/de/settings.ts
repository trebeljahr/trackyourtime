...
export const settings: Translation<typeof source> = {
  ...
  businessProfile: {
    ...
    logo: {
      title: "Logo",
      hint: "Wird oben rechts auf jede neue Rechnung gedruckt. PNG oder JPEG, bis {max} KB. Bereits erstellte Rechnungen behalten das Logo von ihrer Erstellung.",
      none: "Noch kein Logo.",
      alt: "Dein Rechnungslogo",
      ...
      saveFailed: "Das Logo konnte nicht gespeichert werden. Versuch es noch einmal.",
      removeFailed: "Das Logo konnte nicht entfernt werden. Versuch es noch einmal.",
      readFailed: "Die Datei konnte nicht gelesen werden. Wähle eine andere Datei.",
      errors: {
        unsupportedFormat: "Wähle eine PNG- oder JPEG-Datei.",
        tooLarge: "Die Datei ist größer als {max} KB. Exportiere eine kleinere.",
        tooBig: "Das Bild ist an einer Seite größer als {max} px. Exportiere ein kleineres.",
        corrupt: "Die Datei ist kein lesbares Bild. Exportiere sie noch einmal.",
        interlacedPng: "Interlaced-PNGs können nicht gedruckt werden. Exportiere das PNG ohne Interlacing.",
        cmykJpeg: "CMYK-JPEGs können nicht gedruckt werden. Exportiere das JPEG in RGB.",
        unsupportedJpeg: "Dieses JPEG verwendet eine Kodierung, die PDF-Reader nicht unterstützen. Exportiere es als Baseline- oder Progressive-JPEG.",
      },
    },
  },
  twoFactor: {
