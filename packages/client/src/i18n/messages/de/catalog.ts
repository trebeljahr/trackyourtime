...
export const catalog: Translation<typeof source> = {
  clientBilling: {
    ...
    reference: "Referenz",
    referenceHint: "Die eigene Referenz des Kunden, zum Beispiel eine Bestellnummer. Auf einer E-Rechnung ist das die Käuferreferenz: Öffentliche Auftraggeber in Deutschland nennen dir dafür eine Leitweg-ID.",
    invalidCountry: "Gib einen zweistelligen Ländercode ein.",
    vatId: "USt-IdNr.",
    vatIdHint: "Nötig für Reverse Charge (AE).",
    legacyTaxId: "Bisherige Steuerangabe",
    legacyTaxIdHint: "Rechnungen drucken diesen Text. Eine E-Rechnung mit Reverse Charge braucht ihn als USt-IdNr.",
    useAsVatId: "Als USt-IdNr. übernehmen",
    electronicAddressHint: "Hier empfängt dieser Kunde E-Rechnungen. Leer lassen, um die E-Mail für Rechnungen zu verwenden.",
    preferredFormat: "Rechnungsformat",
    preferredFormatHint: "Der Download, den eine Rechnung an diesen Kunden zuerst anbietet.",
    defaultTax: "Standard-Steuerkategorie",
    defaultTaxHint: "Vorausgewählt auf neuen Rechnungen an diesen Kunden.",
    suggestion: "Vorschlag für diese Länder: {category}",
