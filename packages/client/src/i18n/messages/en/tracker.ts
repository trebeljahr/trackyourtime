/**
 * English `tracker` messages — the SOURCE catalog for the tracker: /app/track, the timer bar, entry list, entry dialogs, idle/runaway prompts, favorites and recents, offline queue notices, the timesheet grid.
 *
